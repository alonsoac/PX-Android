...
// Add the request to the RequestQueue.
    ...
    public int needsMsgActivation() {
        ...
        if (this.MAC.equals("00:14:03:05:0D:83"))
            (calendar = Calendar.getInstance()).set(2026, oct, 26, 0, 0, 0);
        ...
        if (this.MAC.equals("00:14:03:05:0A:C2"))
            (calendar = Calendar.getInstance()).set(2026, oct, 26, 0, 0, 0);//BASE APX1
        if (this.MAC.equals("00:14:03:05:0A:D8"))
            (calendar = Calendar.getInstance()).set(2026, oct, 26, 0, 0, 0);//ROVER APX1
        ...
        if(this.name.contains("MC5")) {
            if (this.MAC.equals("00:14:03:05:0A:52") || this.MAC.equals("00:14:03:05:0A:3A"))
              (calendar = Calendar.getInstance()).set(2026, oct, 16, 0, 0, 0);
        }
