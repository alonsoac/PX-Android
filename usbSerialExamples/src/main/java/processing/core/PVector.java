...
public class PVector implements Serializable {
  ...
  public PVector lerp(PVector v, float amt) {
    x = appletlerp(x, v.x, amt);
    y = appletlerp(y, v.y, amt);
    z = appletlerp(z, v.z, amt);
    return this;
  }
   ...
   */
  public PVector lerp(double x, double y, double z, float amt) {
    this.x = appletlerp(this.x, x, amt);
    this.y = appletlerp(this.y, y, amt);
    this.z = appletlerp(this.z, z, amt);
    return this;
  }
  static public final double appletlerp(double start, double stop, float amt) {
