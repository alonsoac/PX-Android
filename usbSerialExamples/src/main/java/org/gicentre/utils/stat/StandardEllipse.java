//https://github.com/gicentre/gicentreutils/blob/master/giCentreUtils/src/org/gicentre/utils/stat/StandardEllipse.java
   ...
   /* public void drawAxes(PApplet sketch)
    ...
    {  
    	...
    	if (majorAxis < minorAxis)
    	{
    		...
    		majorAxis = minorAxis;
    		minorAxis = temp;
    		rotation = (rotation+HALF_PI)%TWO_PI;
    	}
    	...
    	if (wMajorAxis < wMinorAxis)
    	{
    		...
    		wMinorAxis = temp;
    		wRotation = (wRotation+HALF_PI)%TWO_PI;
    	}
    	calcEndpoints();
    }
    ...
    {  
    	...
    	centre = new PVector(RAD2DEG*Math.atan2(sinComp,cosComp),latTotal/points.size());
    	...
    	wCentre = new PVector(RAD2DEG*Math.atan2(sinComp,cosComp),latTotal/weightTotal);
    	...
    	for (PVector p : points)
    	{
    		...
    		double smallestLong = ((p.x+180)-(centre.x+180))%360;
    ...
    {
        // Major axis.
        double x = (axisScale*majorAxis*Math.cos(-rotation)/2.0);
		double y = (axisScale*majorAxis*Math.sin(-rotation)/2.0);
        a1 = new PVector(x,y);
        a2 = new PVector(-x,-y);
        a1.add(centre);
        a2.add(centre);
        ...
        // Minor axis
        x = (axisScale*minorAxis*Math.sin(rotation)/2.0);
        y = (axisScale*minorAxis*Math.cos(rotation)/2.0);
        b1 = new PVector(x,y);
        b2 = new PVector(-x,-y);
        b1.add(centre);
        b2.add(centre);
        ...
        // Weighted major axis.
        x = (axisScale*wMajorAxis*Math.cos(-wRotation)/2.0);
        y = (axisScale*wMajorAxis*Math.sin(-wRotation)/2.0);
        wa1 = new PVector(x,y);
        wa2 = new PVector(-x,-y);
        wa1.add(wCentre);
        wa2.add(wCentre);
        ...
        // Weighted minor axis
        x = (axisScale*wMinorAxis*Math.sin(wRotation)/2.0);
        y = (axisScale*wMinorAxis*Math.cos(wRotation)/2.0);
        wb1 = new PVector(x,y);
        wb2 = new PVector(-x,-y);
        wb1.add(wCentre);
        wb2.add(wCentre);
